...
namespace CodeProject.Dialog
{
    ...
    public sealed class MsgBox
    {
        ...
        public static DialogResult Show(string text)
        {
            ...
            DialogResult dlgResult = MessageBox.Show(text);
            centerWindow.Dispose();
            return dlgResult;
        }
    ...
    internal sealed class CenterWindow
    {
        ...
        public void WndActivate(object sender, CbtEventArgs e)
        {
            ...
            //Tony Update
            ////int dx = (rectForm.left + (rectForm.right - rectForm.left) / 2) - ((rectDlg.right - rectDlg.left) / 2);
            ////int dy = (rectForm.top + (rectForm.bottom - rectForm.top) / 2) - ((rectDlg.bottom - rectDlg.top) / 2);
            ...
            else
            {
                ...
                ////tony 2011.3.12 update
                //USER32.MoveWindow(hMsgBox, rect.Left, rect.Top, 0, 0, 1);
            }
