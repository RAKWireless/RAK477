...
namespace RAK420_Config_Tool
{
    class Wlan_API
    {
        ...
        public struct WLAN_AVAILABLE_NETWORK_LIST
        {
            ...
            internal Wlan.WlanAvailableNetwork[] wlanAvailableNetwork;
            ...
            internal WLAN_AVAILABLE_NETWORK_LIST(IntPtr ppAvailableNetworkList)
            {
                ...
                wlanAvailableNetwork = new Wlan.WlanAvailableNetwork[dwNumberOfItems];

                for (int i = 0; i < dwNumberOfItems; i++)
                {
                    IntPtr pWlanAvailableNetwork = new IntPtr(ppAvailableNetworkList.ToInt32() + i * Marshal.SizeOf(typeof(Wlan.WlanAvailableNetwork)) + 8);
                    wlanAvailableNetwork[i] = (Wlan.WlanAvailableNetwork)Marshal.PtrToStructure(pWlanAvailableNetwork, typeof(Wlan.WlanAvailableNetwork));
                }
            }
        }
    }
