 ...
 *  timeout Definition
 */
#define RAK_TICKS_PER_MISECOND      100 					 //@MCU-M0  12MHz  100ms
...
#define RAK_QCONSATUSTIMEOUT        1 * RAK_TICKS_PER_MISECOND
#define RAK_QIPCFGTIMEOUT           2 * RAK_TICKS_PER_MISECOND
#define RAK_WPSTIMEOUT              60 * RAK_TICKS_PER_MISECOND
#define RAK_EASYCFGTIMEOUT          60 * RAK_TICKS_PER_MISECOND
#define RAK_SCANTIMEOUT							50 * RAK_TICKS_PER_MISECOND
#define RAK_GETSCANTIMEOUT					10 * RAK_TICKS_PER_MISECOND
